        ...
        <div class="hero bg-banner">
            <div class="hero-content text-center text-neutral-content">
                <div class="max-w-md">
                    ...
                    <h1 class="mb-5 text-5xl text-yellow-700 font-bold title">Gadget Mania</h1>
                    <h1 class="mb-5 text-2xl text-yellow-700 font-bold title">All Kind Of Gadget & Gear Accesories Available</h1>
                </div>
            </div>
        </div>
